...
class ExtraControllerSpec extends Specification implements ControllerUnitTest<ExtraController> {
    ...
    void 'Test the save action without any instance'() {
        when: 'Save is called without supplying any values'
